#!/usr/bin/env python3
"""
04_contracts_fase_11_v2.py  Fase XI: Contratos de Validacin Fsica HONESTOS

CORRECCIONES vs v1:
    1. Contratos separados: GENRICOS (aplican a todas) vs AdS-ESPECFICOS
    2. Los contratos AdS-especficos solo se evalan para family="ads"
    3. Geometras non-AdS tienen criterios diferentes (no fallan por no ser AdS)
    4. verify_symmetry hace verificacin real, no "True por construccin"

FILOSOFA:
    - Un contrato genrico debe pasar SIEMPRE (regularidad, causalidad bsica)
    - Un contrato AdS debe pasar solo SI la geometra es AdS
    - El score final es ponderado por tipo de geometra
"""
